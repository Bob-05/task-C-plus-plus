...
Вкратце напомним правила построения поля для игры «Сапёр»:
    ...
    3. пустые клетки содержат число от 0 до 8 — количество мин на соседних клетках.

Формат ввода:
В первой строке содержатся три числа:
    1. число m от 1 до 100 — количество строк на поле;
    2. число n от 1 до 100 — количество столбцов на поле;
    3. число k от 0 до mn — количество мин на поле.
